# VMC ARM Use Story - Codebeamer/Jira 录入版

## 1. 基本信息

- Title: VMC ARM 防侧翻辅助控制功能开发
- Type: Use Story
- Domain: VMC / Chassis Coordination / ARM
- Priority: High
- Status: Draft
- Source: SGMW_VMC ARM_防侧翻功能规范_master
